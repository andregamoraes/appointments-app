			...
			<div className='mx-auto max-w-sm px-4 pt-6 w-full'>
				{!success ? (
					<>
						...
						{error && <div className='mt-4 bg-red-100 text-red-700 text-sm px-4 py-2 rounded-xl'>{error}</div>}
                ...
                `}>
							...
							<button onClick={() => router.back()} className='w-full py-3 rounded-2xl font-semibold bg-white/90 text-gray-800 hover:bg-white transition cursor-pointer'>
								Voltar
							</button>
						</div>
					</>
